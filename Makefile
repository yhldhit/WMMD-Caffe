...
COMMON_FLAGS += $(foreach includedir,$(INCLUDE_DIRS),-I$(includedir)) -Wno-deprecated-gpu-targets
CXXFLAGS += -pthread -fPIC -frounding-math $(COMMON_FLAGS) $(WARNINGS)
NVCCFLAGS += -ccbin=$(CXX) -Xcompiler -fPIC -DCGAL_DISABLE_ROUNDING_MATH_CHECK $(COMMON_FLAGS)
